...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/11 20:19:59 by pnsaka            #+#    #+#             */
/*   Updated: 2024/06/11 20:55:10 by pnsaka           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	std_one_commande(t_cmd *current)
{
	...
	if (stdint_files)
	{
		...
		{
			stdint_files->name_here_doc = ft_strjoin("/tmp/heredoc",
					ft_itoa(stdint_files->heredoc_id));
