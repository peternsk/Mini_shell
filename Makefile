...
BUILTIN		= ft_pwd ft_cd addEnvp printEnvp ft_echo ft_export is_same new_envp same_var_value check_duplicate same_variable is_add size ft_unset is_same_key_value
